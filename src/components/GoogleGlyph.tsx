/** Standard four-color Google "G" mark, used only inside the sign-in button per Google's own button conventions. */
export default function GoogleGlyph({ className = "h-5 w-5" }: { className?: string }) {
  return (
