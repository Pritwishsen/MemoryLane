/**
 * Country field on a page is free text a host types in (no dropdown/
 * autocomplete) — this maps common English names and a few frequent
 * aliases to an ISO 3166-1 alpha-2 code so the map can show a flag.
 * Deliberately forgiving about casing/whitespace; anything that doesn't
 * match falls back to no flag rather than guessing wrong.
 */
